# acute/chronic + 2 risk levels + assortativity 
...
# other parameters: 
prisk2 = .30 #approximate proportion new infections in risk level 2 
assortprob = .0 # prob that transmission goes to same  group as donor 
gamma0 = 1.
gamma1 = 1/9. 
mu = 1/40.;
beta = .25 
...
def state2rates(x):
	...
	return [ r12, r2d, d1, d2, d_s, f, birth, r12_2, r2d_2, d1_2, d2_2 ]
#
